<template>
  ...
  <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
      <router-link class="navbar-brand brand-logo mr-5" to="/"><img :src="img1" class="mr-2" alt="logo"/></router-link>
      <router-link class="navbar-brand brand-logo-mini" to="/"><img :src="img2" alt="logo"/></router-link>
    </div>
